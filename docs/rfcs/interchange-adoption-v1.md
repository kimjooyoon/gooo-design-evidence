# Design-evidence interchange adoption v1

## Decision

The design evidence exports one advisory five-file interchange bundle. It does not mutate the observed project and it does not make another repository branch a required gate.
